...
# Database: health_e
# Generation Time: 2023-12-01 16:18:26 +0000
# ************************************************************
...
VALUES
	...
	(10, 'View All Patients', 'view-all-clients', NULL, NULL),
	...
	(50, 'See Patients Menu', 'see-clients-menu', NULL, NULL),
	...
	(64, 'View BP Readings for Physicans Patients', 'view-bp-readings-for-physicians-patients', NULL, NULL),
	(65, 'View Physicans Dashboard', 'view-physicians-dashboard', NULL, NULL),
	(66, 'View Admin Dashboard', 'view-admin-dashboard', NULL, NULL),
	(67, 'View BP Readings for All Patients', 'view-bp-readings-for-all-patients', NULL, NULL),
	(68, 'View Patient Information', 'view-patient-information', NULL, NULL),
	(69, 'View Nurse Dashboard', 'view-nurse-dashboard', NULL, NULL),
	(70, 'Onboard Patient', 'onboard-patient', NULL, NULL),
	(71, 'Add Caregiver for patient', 'add-caregiver-for-patient', NULL, NULL),
	(72, 'Assign BP Device to patient', 'assign-bp-device-to-patient', NULL, NULL),
	(73, 'insert onboarding checklist responses', 'insert-onboarding-checklist-responses', NULL, NULL),
	(74, 'View BP Readings for a Patient', 'view-bp-readings-for-a-patient', NULL, NULL),
	(75, 'View BP Readings for a Patient By Status', 'view-bp-readings-for-a-patient-by-status', NULL, NULL),
	(76, 'Update Patients BP Graph', 'update-patients-bp-graph', NULL, NULL),
	(77, 'View BP Reading Details for a Patient', 'view-bp-reading-details-for-a-patient', NULL, NULL),
	(78, 'View No. of patients for physicians report', 'view-no-of-patients-for-physicians-report', NULL, NULL),
	(79, 'View Avg Monthly BP Reading for a patient report', 'view-avg-monthly-bp-reading-for-a-patient-report', NULL, NULL),
	(80, 'Get Years from Patient Data', 'get-years-from-patient-data', NULL, NULL);
